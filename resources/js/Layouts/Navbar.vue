...
<template>
    <header class="fixed top-0 left-0 w-full z-50 bg-white shadow">
            ...
            <div class="flex flex-1 items-center justify-end md:justify-between">
                ...
                <div class="flex items-center gap-4">
                    <div class="sm:flex sm:gap-4">
                        <Link :href="route('login')" class="block rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-teal-700">Login</Link>
        ...
        <div v-show="showingNavigationDropdown" class="md:hidden px-4 pb-4">
            <ul class="space-y-2 text-sm text-gray-700">
                <li><a class="block py-2 hover:text-teal-600" href="#">About</a></li>
                <li><a class="block py-2 hover:text-teal-600" href="#">Careers</a></li>
                <li><a class="block py-2 hover:text-teal-600" href="#">History</a></li>
                <li><a class="block py-2 hover:text-teal-600" href="#">Services</a></li>
                <li><a class="block py-2 hover:text-teal-600" href="#">Projects</a></li>
                <li><a class="block py-2 hover:text-teal-600" href="#">Blog</a></li>
                <li><a class="block py-2 hover:text-teal-600" href="#">Login</a></li>
                <li><a class="block py-2 hover:text-teal-600" href="#">Register</a></li>
            </ul>
        </div>
    </header>
</template>
